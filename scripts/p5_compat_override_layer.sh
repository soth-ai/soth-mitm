...
run_case core_override_provenance \
  cargo test --features soth-mitm/__internal -p soth-mitm --lib compatibility_override_decision_emits_provenance_fields -q
run_case sidecar_disable_h2_host_override \
  cargo test --features soth-mitm/__internal -p soth-mitm --test http2_mitm -q
