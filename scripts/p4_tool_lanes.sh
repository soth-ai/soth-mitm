...
lane_proptest_and_fuzz() {
  ...
  cargo test --all-features -p soth-mitm --test connect_parser_proptest -q
  cargo test --all-features -p soth-mitm --test grpc_envelope_proptest -q
  cargo test --all-features -p soth-mitm --test sse_parser_proptest -q
  cargo test --all-features -p soth-mitm --test tls_classification_proptest -q
