...
if rg -n \
  ...
  crates/mitm-sidecar/src crates/mitm-core/src -g '*.rs' >"$report_dir/unexpected-surface.txt"; then
...
if rg -n "bind_listener_with_socket_hardening" crates/mitm-sidecar/src/socket_hardening.rs -q; then
