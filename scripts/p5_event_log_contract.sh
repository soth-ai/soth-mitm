...
run_case observe_v2_deterministic_record \
  cargo test --features soth-mitm/__internal -p soth-mitm --test event_log_v2 deterministic_record_v2_ -q
run_case observe_v2_rotation_index \
  cargo test --features soth-mitm/__internal -p soth-mitm --test event_log_v2 \
