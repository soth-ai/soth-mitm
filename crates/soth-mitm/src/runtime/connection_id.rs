...
pub(crate) fn connection_id_for_flow_id(flow_id: u64) -> Uuid {
    ...
    let seeded = flow_id.wrapping_add(1);
    let a = seeded.wrapping_mul(0x9E37_79B9_7F4A_7C15);
    let b = seeded.wrapping_mul(0x517C_C1B7_2722_0A95).wrapping_add(0x6C62_272E_07BB_0142);
