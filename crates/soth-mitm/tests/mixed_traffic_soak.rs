...
use soth_mitm::test_observe::{EventConsumer, EventType, VecEventConsumer};
use soth_mitm::test_policy::DefaultPolicyEngine;
use soth_mitm::test_server::{RuntimeGovernor, SidecarConfig, SidecarServer};
...
fn build_engine(
    ...
    build_engine_with_sink(config, soth_mitm::test_observe::NoopEventConsumer)
}
